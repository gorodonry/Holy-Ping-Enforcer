...
class Modes(Enum):
  ...
  Random pings - has a 2% chance of pinging you if you don't ping the target with every message.
  """
  ANNOY_EVERYONE = 0
  REMINDER = 1
  RANDOM_PINGS = 2
...
FEEDBACK_MESSAGES = [
  f"You've been naughty :index_pointing_at_the_viewer: - grabbing <@{TARGET_ID}> rn",
...
PRIDE_MESSAGES = [
  "<:redguy:1106525937136324688> <:orangeguy:1106525377708429352> <:yellowguy:1106524765977583657> <:greenguy:1095161810870607953> <:blueguy:1095161113773101229> <:pinkguy:1106523189238050886> <:purpleguy:1106524177663528990>"
]
...
async def on_ready():
  ...
  if MODE == Modes.PRIDE_MONTH and PRIDE_MONTH_STARTING:
    await bot.get_channel(CHANNEL_IDS["Announcements"]).send("<:redguy:1106525937136324688> <:orangeguy:1106525377708429352> <:yellowguy:1106524765977583657> <:greenguy:1095161810870607953> <:blueguy:1095161113773101229> <:pinkguy:1106523189238050886> <:purpleguy:1106524177663528990> Pride month is here :D <:purpleguy:1106524177663528990> <:pinkguy:1106523189238050886> <:blueguy:1095161113773101229> <:greenguy:1095161810870607953> <:yellowguy:1106524765977583657> <:orangeguy:1106525377708429352> <:redguy:1106525937136324688>")
  ...
  while True:
    ...
    match MODE:
      ...
      case Modes.PRIDE_MONTH:
        await bot.get_channel(CHANNEL_IDS["General"]).send(random.choice(PRIDE_MESSAGES))
      case _:
        pass
  ...
  match MODE:
    case Modes.ANNOY_EVERYONE:
      if TARGET_ID not in [u.id for u in message.mentions]:
        await message.channel.send(f"{message.author.mention} {random.choice(FEEDBACK_MESSAGES)}")
    case Modes.REMINDER:
...
async def on_message_edit(before, after):
  if MODE == Modes.ANNOY_EVERYONE and TARGET_ID not in [u.id for u in after.mentions]:
    await after.channel.send(
      f"You though you were so clever didn't you {after.author.mention} >:C\n{random.choice(FEEDBACK_MESSAGES)}"
    )
